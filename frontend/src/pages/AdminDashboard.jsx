      ...
      <div className='flex justify-between items-center p-4'>
        ...
        <div className="mb-4 flex gap-2 items-center">
          <button 
            ...
            className={`px-4 text-md duration-300 transition-all font-medium w-32 py-2 rounded mr-2 ${showList === 'company' ? 'bg-blue-700' : 'bg-white border border-blue-700 text-blue-700'} text-white`}
          >
            Companies
          </button>
          <button 
            onClick={() => setShowList('job')} 
            className={`px-4 text-md duration-300 transition-all font-medium w-32  py-2 rounded ${showList === 'job' ? 'bg-blue-700 '  : 'bg-white border border-blue-700 text-blue-700'} text-white`}
          >
            Jobs
          </button>
        </div>
