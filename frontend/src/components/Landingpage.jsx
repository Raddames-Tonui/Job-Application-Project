      ...
      <div className="max-w-md w-full bg-white p-8 rounded shadow-lg">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input id="email" type="email" className="w-full border-gray-300 rounded px-4 py-2" placeholder="Enter your email" />
          </div>
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-gray-700">Password</label>
            <input id="password" type="password" className="w-full border-gray-300 rounded px-4 py-2" placeholder="Enter your password" />
          </div>
